...
namespace Kajo.Common
{
    public static class Security
    {
        ...
        public static bool VerifyJwtToken(this HttpRequest request, out IPrincipal principal, out string errorMessage)
        {
            try
            {
